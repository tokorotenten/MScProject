...
#from .orbits2 import Orbit2
from ..inducing_variables.transforms import Transform


class Invariant(gpflow.kernels.Kernel):
    def __init__(self, basekern: gpflow.kernels.Kernel, orbit: Orbit, trans: Transform):
        super().__init__()
...
class StochasticInvariant(Invariant):
    def __init__(self, basekern: gpflow.kernels.Kernel, orbit: Orbit, trans: Transform):
        super().__init__(basekern, orbit, trans)
